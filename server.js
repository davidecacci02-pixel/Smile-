...
function buildEmailHtml(participant, qrCodeSrc) {
  ...
  const noteBlock = finalNoteText
    ? `<div style="margin-top: 18px; padding: 18px 20px; border-radius: 18px; background: #f8fafc; border: 1px solid #d1d5db; color: #111827; font-size: 13px; line-height: 1.7; box-shadow: inset 0 0 0 1px rgba(148,163,184,0.08);">
          <div style="font-size: 11px; font-weight: 800; letter-spacing: 0.16em; text-transform: uppercase; color: #111827; margin-bottom: 10px;">NOTA</div>
