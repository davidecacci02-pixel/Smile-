...
function selectEmail(id) {
  ...
  if (emailNote) {
    ...
    mailNotePreview.innerHTML = `
      <div style="padding: 14px 16px; border-radius: 16px; background: #eef2ff; border: 1px solid #c7d2fe; color: #0f172a; font-size: 13px; line-height: 1.7; box-shadow: 0 1px 8px rgba(15,23,42,0.08);">
        <div style="font-size: 10px; font-weight: 800; letter-spacing: 0.14em; text-transform: uppercase; color: #0f172a; margin-bottom: 8px;">NOTA</div>
        <div style="font-style: italic; color: #111827; font-weight: 600;">${escapeHtml(emailNote)}</div>
      </div>
    `;
  } else {
